...
All of the dependencies for the mod are included with the VFX Scripts, so if you aren't getting any VFX, it's likely because you're missing something there.
