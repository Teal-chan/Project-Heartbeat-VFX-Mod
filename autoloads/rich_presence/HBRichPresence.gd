...
# NEW: Media player info
var current_media_title: String = ""
var current_media_artist: String = ""
...
# NEW: Media player notification
func notify_media_player(title: String, artist: String):
	current_stage = RichPresenceStage.STAGE_MEDIA_PLAYER
	current_media_title = title
	current_media_artist = artist
	notify_rich_presence_update()
