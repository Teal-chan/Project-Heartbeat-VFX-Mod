...
# Override in subclasses - returns true if this modifier is purely cosmetic
# and doesn't affect gameplay, allowing leaderboard submission
static func is_leaderboard_legal() -> bool:
	return false  # Default: modifiers block leaderboards
